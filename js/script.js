...
function calcularHoraExtra() {
    ...
    // Define as horas trabalhadas fixas como 220
    ...
    // Cálculo das horas extras com os respectivos adicionais
    const valorHoraExtra50 = valorHoraNormal * 1.50;
    const valorHoraExtra70 = valorHoraNormal * 1.70;
    const valorHoraExtra100 = valorHoraNormal * 2.00;
    ...
    // Define os domingos e feriados de cada mês
    const domingosFeriados = {
        1: 5, 2: 4, 3: 5, 4: 6, 5: 7, 6: 5,
        7: 4, 8: 5, 9: 5, 10: 5, 11: 8, 12: 5
    };
    ...
    const diasUteis = diasNoMes[mes] - domingosFeriados[mes];
    ...
    document.getElementById('resultado100').textContent = `R$ ${total100.toFixed(2)}`;
    document.getElementById('resultadoTotal').textContent = `R$ ${totalExtras.toFixed(2)}`;
    document.getElementById('dsrTotal').textContent = `R$ ${dsr.toFixed(2)}`;
